                            ...
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Data Collect</th>
                                        <th>Data Verified</th>
                                        <th>Pending in Email Ver</th>
                                        <th>Pending in CDQA</th>
                                        <th>Pending in QA</th>
                                        <th>Pending Lead Score</th>
                                        <th>QA Accepted</th>
                                        <th>QA Rejected</th>
                                        <th>Total Records</th>
                                    </tr>
                                ...
                                <?php foreach($campaigns as $post) : ?>
                                 <tr>
                                        <td><?php echo $post['loaddt']; ?></td>
                                        <td>  <?php $query = $this->db->query("SELECT * FROM leadmaster  ");
                                                    echo $query->num_rows();?></td>
