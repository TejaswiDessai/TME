    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card" id="camp_form">
              <!-- <form id="basic-form" method="POST" enctype="multipart/form-data" action="leadgeneration"> -->
              <form id="basic-form" method="POST" enctype="multipart/form-data" action="leadgenerationinterface">
