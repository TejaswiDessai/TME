                ...
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                            ...
                            <div class="text-center">
                                <img src="<?php echo base_url(); ?>assets/images/ME-Logo-new-new-logo-white-1536x400-1.png" alt="logo.png" style="width:230px">
                            </div>
                            ...
                            <div class="auth-box">
                                ...
                                <hr/>
                                  <?php echo form_open('administrator/start_test'); ?>
                                 
                                <div class="input-group">
                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Your Phone Number" onkeypress="return isNumber(event)" autocomplete="off" required>
...
<!--                                    <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Start Test</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
